                ...
                with st.container(border=True):
                    ...
                    if modo_busca == "Quilometragem":
                        ...
                        msg_motorista = (
                            ...
                            f"A última foi com {km_ultima_visita_str} km e, com base no histórico de nosso sistema, já rodou aproximadamente {km_rodados_str} km desde então, estando agora com cerca de {km_atual_estimada_str} km.\n\n"
                        ...
                        msg_gestor = (
                            f"Olá, {veiculo['nome_responsavel']}, tudo bem?\n\n"
                            f"Somos da Capital Truck Center e, em nosso acompanhamento da sua frota, identificamos uma necessidade de revisão para o veículo {veiculo['modelo']}, placa {veiculo['placa']}.\n\n"
                            f"A última manutenção foi em {veiculo['data_ultima_visita'].strftime('%d/%m/%Y')} com {km_ultima_visita_str} km. Com base no histórico de nosso sistema, o veículo rodou aproximadamente {km_rodados_str} km desde então, e nossa projeção indica que está agora com cerca de {km_atual_estimada_str} km.\n\n"
